...
function ActivityItem({ attempt }: { attempt: any }) {
  ...
  return (
    <div className="relative pl-6 pb-2 border-l-2 border-gray-100 last:border-0 last:pb-0">
      <div className="absolute -left-[9px] top-0 w-4 h-4 rounded-full bg-white border-2 border-indigo-100 transition-colors group-hover:border-indigo-500"></div>
