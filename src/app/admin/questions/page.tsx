    ...
    return (
        <AdminPage>
            <AdminPageHeader
                ...
                actions={
                    <div className="flex space-x-3">
                        ...
                        >
                            <ArrowUpTrayIcon className="w-5 h-5 mr-2 text-gray-500 dark:text-gray-400" />
                            Import CSV
                        </button>
                        <button
            ...
            <AdminPageContent>
                ...
                <div className="bg-white dark:bg-gray-900 p-4 rounded-lg shadow-sm border border-gray-200 dark:border-gray-800 space-y-4 md:space-y-0 md:flex md:items-center md:justify-between md:space-x-4 transition-colors">
                    <div className="flex flex-wrap items-center gap-4">
                        ...
                        <select
                            ...
                            className="block w-32 pl-3 pr-10 py-1.5 text-sm border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md"
                        >
