    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-10">
                ...
                <div className="container mx-auto px-4">
                    <div className="flex border-b border-gray-200">
                        <div className="flex-1 py-3 flex justify-center border-b-2 border-gray-200">
            ...
            <main className="container mx-auto px-4 py-6 max-w-2xl space-y-3">
                {[...Array(8)].map((_, i) => (
                    <div key={i} className="flex items-center justify-between p-4 rounded-xl bg-white border border-gray-200 shadow-sm">
                        <div className="flex items-center space-x-4">
