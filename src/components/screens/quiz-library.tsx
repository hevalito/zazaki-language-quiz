            ...
            <header className="bg-white dark:bg-gray-900 shadow-sm border-b border-gray-200 dark:border-gray-800 sticky top-0 z-10 transition-colors">
                <div className="container mx-auto px-4 py-4">
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            <h1 className="text-xl font-bold text-gray-900 dark:text-gray-100">{t('library.title', 'Bibliothek')}</h1>
                            <p className="text-sm text-gray-500 dark:text-gray-400">{t('library.subtitle', 'Entdecke und lerne')}</p>
                        </div>
                    </div>
                </div>
            </header>
            ...
            <div className="container mx-auto px-4 py-6">
                ...
                <div className="relative mb-6">
                    ...
                    <input
                        ...
                        className="block w-full pl-10 pr-3 py-3 border border-gray-300 dark:border-gray-700 rounded-xl leading-5 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all shadow-sm focus:bg-white dark:focus:bg-gray-900"
                        value={searchQuery}
                ...
                {loading ? (
                    ...
                    <div className="text-center py-12">
                        ...
                        <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">{t('library.empty.title', 'Keine Quizze gefunden')}</h3>
                        <p className="text-gray-500 dark:text-gray-400 mt-2">{t('library.empty.desc', 'Versuche es mit einem anderen Suchbegriff oder Filter.')}</p>
                    </div>
                )}
            </div>
        </div>
